# push-config-to-github - Work Plan
...
- Evidence: .omo/evidence/task-<N>-push-config-to-github.<ext>
...
- [ ] 1. <title>
  ...
  QA scenarios (name the exact tool + invocation): happy + failure, Evidence .omo/evidence/task-1-push-config-to-github.<ext>
